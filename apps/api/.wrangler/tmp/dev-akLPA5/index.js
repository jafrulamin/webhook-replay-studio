...
app.post("/api/inboxes", async (c) => {
  ...
  if (!c.env || !c.env.DB) {
    ...
    return c.json({ error: "Database binding not available", envKeys }, 500);
  }
...
// .wrangler/tmp/bundle-Ke4C6d/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Ke4C6d/middleware-loader.entry.ts
